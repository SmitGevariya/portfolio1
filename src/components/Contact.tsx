  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        to_email: 'smitgevariya.sg141@gmail.com', // Your email
      };
  ...
  const contactInfo = [
    {
      icon: <Mail size={24} />,
      title: 'Email',
      value: 'smitgevariya.sg141@gmail.com',
      link: 'mailto:smitgevariya.sg141@gmail.com'
    },
    {
      icon: <Phone size={24} />,
      title: 'Phone',
      value: '+91 81288 46206',
      link: 'tel:+918128846206'
    },
    {
      icon: <MapPin size={24} />,
      title: 'Location',
  ...
  const socialLinks = [
    {
      icon: <Github size={24} />,
      name: 'GitHub',
      url: 'https://github.com/SmittGevariya'
    },
    {
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className={`w-full inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg ${
              ...
              {submitStatus === 'error' && (
                ...
                >
                  ❌ Failed to send message. Please try again or contact me directly at smitgevariya.sg141@gmail.com
                </motion.div>
              )}
            </form>
          </motion.div>
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="p-4 bg-gray-50 rounded-lg text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-all duration-200"
                  >
                    {social.icon}
                  </motion.a>
                ))}
